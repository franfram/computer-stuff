# Enable Powerlevel10k instant prompt. Should stay close to the top of ~/.zshrc. Initialization 
# code that may require console input (password prompts, [y/n] confirmations, etc.) must go 
...
# Uncomment the following line to use hyphen-insensitive completion. Case-sensitive completion 
# must be off. _ and - will be interchangeable. HYPHEN_INSENSITIVE="true"

# Uncomment one of the following lines to change the auto-update behavior zstyle ':omz:update' 
# mode disabled # disable automatic updates zstyle ':omz:update' mode auto # update 
# automatically without asking zstyle ':omz:update' mode reminder # just remind me to update 
# when it's time

# Uncomment the following line to change how often to auto-update (in days). zstyle 
# ':omz:update' frequency 13
...
# Uncomment the following line to display red dots whilst waiting for completion. You can also 
# set it to another string to have that shown instead of the default red dots. e.g. 
# COMPLETION_WAITING_DOTS="%F{yellow}waiting...%f" Caution: this setting can cause issues with 
# multiline prompts in zsh < 5.7.1 (see #5765) COMPLETION_WAITING_DOTS="true"
...
# Uncomment the following line if you want to change the command execution time stamp shown in 
# the history command output. You can set one of the optional three formats: 
...
__conda_setup="$('/home/franfram/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/franfram/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/franfram/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/franfram/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

export MODULAR_HOME="/home/franfram/.modular"
export PATH="/home/franfram/.modular/pkg/packages.modular.com_mojo/bin:$PATH"
export MODULAR_HOME="/home/franfram/.modular"
export PATH="/home/franfram/.modular/pkg/packages.modular.com_mojo/bin:$PATH"
export XDG_DATA_DIRS="$XDG_DATA_DIRS:/var/lib/flatpak/exports/share:/home/franfram/.local/share/flatpak/exports/share"
